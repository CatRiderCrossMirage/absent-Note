...
<body>
    <div class="container mt-5">
        ...
        <form action="absentRestPDF.php" class="needs-validation offset-md-3 col-md-6" method="POST" novalidate>
            ...
            <div class="row mb-2">
                <div class="form-floating col-md-4">
                    <input type="text" name="sumRest" placeholder="วันลาพักผ่อนสะสม" class="form-control" id="validationsunRest" required></input>
                    <label for="floatingInput"> วันลาพักผ่อนสะสม</label>
                    <div class="invalid-feedback">
                        กรุณากรอกวันลาพักผ่อนสะสม <br><br>
                    </div>
                </div>
                <div class="form-floating col-md-4">
                    มีสิทธิลาพักผ่อนประจำปีนี้อีก 10 วันทำการ
                </div>
                <div class="form-floating col-md-4">
                    <input type="text" name="sumRestALL" placeholder="วันลาพักผ่อนสะสม" class="form-control" id="validationsunRestALL" required></input>
                    <label for="floatingInput"> รวมวันลาพักผ่อนสะสม</label>
                    <div class="invalid-feedback">
                        กรุณากรอกรวมวันลาพักผ่อนสะสม <br><br>
                    </div>
                </div>
            </div>
            
            <!-- วันที่จะลาจริงๆ -->
            กรุณากรอกวันที่ลาพักผ่อน และจำนวนวัน
            <div class="row mb-2">
                <div class="form-floating col-md-4">
            ...
            <div class="form-floating mb-2">
                <input type="text" name="contract" placeholder="ติดต่อได้ที่" class="form-control" id="validationContract" required></input>
                <label for="floatingInput">ติดต่อได้ที่</label>
                <div class="invalid-feedback">
                    กรุณากรอกสถานที่ติดต่อได้ <br><br>
                </div>
            </div>
