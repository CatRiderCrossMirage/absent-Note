...
<body>
    <div class="container mt-5">
        ...
        <form action="cancle-absentPDF.php" class="needs-validation offset-md-3 col-md-6" method="POST" novalidate>
            <h1>แบบใบขอยกเลิกการลา</h1>
            <p>กรุณากรอกข้อมูลในช่องให้ถูกต้องและครบถ้วน หลังจากนั้นกดปุ่มจะได้ไฟล์เอกสาร .pdf</p>
            <div class="row mb-2">
            ...
            <div class="row mb-2">
                ...
                <div class="form-check-floating col-md">
                    <label for="">ได้รับอนุญาติให้ลา</label><br>
            ...
            <!-- วันที่จะลาจริงๆ -->
            กรุณากรอกวันที่ได้ลา และจำนวนวัน
            <div class="row mb-2">
                ...
                <div class="form-floating col-md-4">
                    ...
                    <div class="invalid-feedback">
                        กรุณากรอกจำนวนวันที่ได้ลา <br><br>
                    </div>
                </div>
                <div class="form-floating col-md-10" style="margin-top:1.5rem;">
                    ...
                    <label for="floatingInput">ต้องการยกเลิกการลาเนื่องจาก</label>
                    <div class="invalid-feedback">
                        กรุณากรอกสาเหตุการยกเลิกการลา <br>
                    </div>
                </div>
