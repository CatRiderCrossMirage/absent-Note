...
<body>
    <div class="container mt-5">
        ...
        <form action="absentNote.pdf" class="needs-validation offset-md-3 col-md-6" method="POST" novalidate>
            <h1>แบบใบคำร้องขอย้ายคณะ / ขอย้ายสาขาวิชาเรียน</h1>
            ...
            ประสงค์ขอย้ายคณะ / สาขา 
            <div class="row mb-1">
                

                <div class="form-floating col-md-10" style="margin-top:1.5rem;">
                    <textarea type="message" name="majorOld" placeholder="สาขาเดิม" class="form-control" id="validationMessage"required></textarea>
                    <label for="floatingInput">คณะ / สาขาเดิม</label>
                    <div class="invalid-feedback">
                        กรุณากรอกคณะ / สาขาเดิม <br>
                    </div>
                </div>
                <div class="form-floating col-md-10" style="margin-top:1.5rem;">
                    <textarea type="message" name="majorNew" placeholder="สาขาใหม่ที่ขอย้าย" class="form-control" id="validationMessage"required></textarea>
                    <label for="floatingInput">คณะ / สาขาใหม่ที่ขอย้าย </label>
                    <div class="invalid-feedback">
                        กรุณากรอกคณะ / สาขาใหม่ที่ขอย้าย<br>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-2">
                ...
                <div class="form-floating col-md-10" style="margin-top:1.5rem;">
                    <textarea type="message" name="numdoc" placeholder="จำนวนเอกสาร" class="form-control" id="validationMessage"required></textarea>
                    <label for="floatingInput">จำนวนเอกสารผลการเรียนที่แนบมา</label>
                    <div class="invalid-feedback">
                        กรุณากรอกจำนวนเอกสาร<br>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-2">
                ...
                <div class="form-floating col-md-10" style="margin-top:1.5rem;">
                    <textarea type="message" name="motiveBecuase" placeholder="สาเหตุการลา" class="form-control" id="validationMessage"required></textarea>
